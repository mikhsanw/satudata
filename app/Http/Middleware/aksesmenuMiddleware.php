            ...
            if($menu->tampil){
                ...
                if($bolehakses)
                {
                    ...
                    if($aksessub->first()){
                        ...
                        return new Response(view('backend.home.error.403', ['menu'=>$menu]));
                    }
                } else {
                    return new Response(view('backend.home.error.503', ['menu'=>$menu]));
                }
            }else{
                return $next($request);
            }
        }else{
            return new Response(view('backend.home.error.403'));
        }
    }
}
