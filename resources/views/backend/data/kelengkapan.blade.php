<div id="kelengkapan">
    ...
    <div class="row">
        ...
        <p>
            ...
            {!! Form::label('satuan', 'Masukkan Satuan', array('class' => 'control-label')) !!}
            {!! Form::text('satuan', $data->satuan, array('id' => 'satuan', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
        </p>
        <p>
            <small class="text-danger"> *</small>
            {!! Form::label('wilayah', 'Pilih wilayah', array('class' => 'control-label')) !!}
            {!! Form::select('wilayah_id', $wilayah, $data->wilayah_id, array('id' => 'wilayah', 'class' => 'select2 form-control wilayah', 'placeholder'=>'Pilih')) !!}
        </p>
        <p>
            {!! Form::label('keterangan', 'Tambahkan keterangan', array('class' => 'control-label')) !!}
            {!! Form::textarea('keterangan', $data->keterangan, array('id' => 'keterangan', 'class' => 'form-control js-summernote')) !!}
        </p>
        </div>
