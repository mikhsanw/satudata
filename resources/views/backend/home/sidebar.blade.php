<aside class="page-sidebar">
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative">
            @if($aplikasi->file_favicon)
                ...
                <span class="page-logo-text mr-1 font-weight-bold">{{ $aplikasi->singkatan ?? '' }}</span>
            @endif
        </a>
    </div>
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card">
            ...
            <div class="info-card-text">
                ...
                <span class="d-inline-block text-truncate text-truncate-sm">
                    {!! ucwords(strtolower(config('master.level.'.$user->level))) !!}
                </span>
            </div>
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            @include('backend.home.sidebar_item.menu',['menu_item'=>$menu_item])
        </ul>
