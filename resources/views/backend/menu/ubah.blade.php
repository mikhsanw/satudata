...
<div class="row">
    ...
    <div class="col-md-6">
        <p>
            ...
            {!! Form::select('model', $model, $menu->detail['model'] ?? NULL,array('id' => 'model', 'class' => 'form-control select2', 'placeholder' => 'Pilih Model (optional)')) !!}
        </p>
    </div>
    <div class="col-md-3">
        <p>
...
<script src="{{ URL::asset(config('master.aplikasi.author').'/home/ajax.js') }}"></script>
