  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="{{url('')}}#about" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Satu Data</span></a></li>
        <li><a href="{{url('')}}#resume" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Jenis Data</span></a></li>
        <li><a href="{{url('')}}#portfolio" class="nav-link scrollto"><i class="bx bx-book-content"></i> <span>Publikasi</span></a></li>
        <li><a href="{{url('')}}#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Data Sektoral</span></a></li>
